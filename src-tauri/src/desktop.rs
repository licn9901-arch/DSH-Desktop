...
fn show_about(app: &AppHandle) {
    let _ = app
        .dialog()
        .message(format!(
            "DeepSeek Harness Desktop {}\n\n社区项目，非 DeepSeek 官方产品。\n\n内置 DSH 0.1.0-rc.8、DSH Market 1.17.1、pnpm 10.34.5\n插件：GenUI 0.8.6、Better Sidebar 0.14.0、Skin Center 0.2.6、Hindsight 0.4.1、ModLens 3.22.1、Skills/MCP 0.2.4\n\nDSH rc.8 已原生提供 @ 文件引用。第三方插件与桌面应用拥有相同主机权限，目前没有签名验证、权限清单或进程级沙箱。",
