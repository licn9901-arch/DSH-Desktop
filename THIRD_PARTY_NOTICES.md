...
| `dshmarket` / generated `dshmarket-desktop` alias | 1.6.0 | MIT, <https://github.com/dsh-market/dsh-market> |
...
The packaged `dshmarket-desktop` directory is generated from the pinned `dshmarket` payload. Its package name and strict client module registration ID are adapted for the desktop-private Cordis entry; all other client bundle bytes remain identical to the upstream payload.
