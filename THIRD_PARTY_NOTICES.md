...
| `dshmarket` | 1.9.0 | MIT, <https://github.com/dsh-market/dsh-market> |
| `pnpm` | 9.15.9 / 10.33.2 / 11.22.0 | MIT, <https://github.com/pnpm/pnpm> |
...
The packaged Market keeps its upstream `dshmarket` package and client registration identity. Desktop Runtime Services select a pinned pnpm major that matches the active profile without rebuilding or moving the user's pnpm store.
